                ...
                <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-12">
                    <div className="flex items-start gap-6">
                        <div className="relative w-16 h-16 flex-shrink-0">
                            <Image src="/location.png" layout="fill" objectFit="contain" alt="Location Icon" />
                        </div>
                        <div className="flex flex-col gap-2 min-w-0"> {/* Added min-w-0 to allow proper text wrapping */}
                            <h1 className="font-semibold">Our Location</h1>
                            <p className="text-gray-700 break-words">{sanityData?.contact?.location}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-6">
                        ...
                        <div className="flex flex-col gap-2 min-w-0">
                            ...
                            {sanityData.contact.email.map((item, index) => (
                                <p key={index} className="text-gray-700 break-words">{item}</p>
                            ))}
                        </div>
                    </div>
